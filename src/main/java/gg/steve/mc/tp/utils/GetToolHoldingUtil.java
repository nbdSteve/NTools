...
//    public static ToolType getHoldingType(NBTItem item) {
//        if (item.getString("tools+.type").equalsIgnoreCase("")) return null;
//        return ToolType.valueOf(item.getString("tools+.type").toUpperCase());
//    }
//
//    public static String getHoldingName(NBTItem item) {
//        if (item.getString("tools+.name").equalsIgnoreCase("")) return null;
//        return item.getString("tools+.name");
//    }
