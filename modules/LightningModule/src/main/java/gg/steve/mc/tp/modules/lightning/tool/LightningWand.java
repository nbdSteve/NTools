...
public class LightningWand extends AbstractTool {

    public LightningWand(String moduleId, NBTItem item, PluginFile file) {
        super(moduleId, item, file);
